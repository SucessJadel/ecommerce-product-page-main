...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function () {
    ...
    $(
      '<div id="lightboxOverlay" tabindex="-1" class="lightboxOverlay"></div><div id="lightbox" tabindex="-1" class="lightbox" class="shoe"><div id="lb-outercontainer" class="lb-outerContainer"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="alt=""/><div id="thumbnail" class="thumbnail"><a href="images/image-product-1.jpg"><div class="thumbnail-box selected"><img src="images/image-product-1-thumbnail.jpg"/></div></a><a href="images/image-product-2.jpg"><div class="thumbnail-box"><img src="images/image-product-2-thumbnail.jpg" /></div></a><a href="images/image-product-3.jpg"><div class="thumbnail-box"><img src="images/image-product-3-thumbnail.jpg" /></div></a><a href="images/image-product-4.jpg"><div class="thumbnail-box"><img src="images/image-product-4-thumbnail.jpg" /></div></a></div><div class="lb-nav"><a class="lb-prev" role="button" tabindex="0"aria-label="Previous image" href=""></a><a class="lb-next" role="button" tabindex="0" aria-label="Next image" href=""></a></div><div class="lb-loader"><a class="lb-cancel" role="button" tabindex="0"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-close" role="button" tabindex="0"></a></div></div></div></div>'
    ).appendTo($("body"));
